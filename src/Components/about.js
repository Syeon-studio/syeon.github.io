    ...
    return(
        <div className="about">
            ...
            <div className='contents'>
                ...
                <div className='description'>I am a second year Master candidate in the Department of Industrial Design at KAIST. I am working with <a href='https://galaxytourist.notion.site/galaxytourist/Hwajung-Hong-cc10b0291bbe4ca38dbf4882cd687423'>Prof. Hwajung Hong</a> at <a href='https://dxd-lab.github.io/'>DxD Lab</a>. <br/><br/> My research interest is supporting human cognitive reframing with XR technology with a strong emphasis on a Human-Centered design approach. In particular, I have explored how the virtual experience could improve people's mental well-being.</div>
                <div className='icons'>
